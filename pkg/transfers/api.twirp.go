...
func NewAPIProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) API {
	...
	serviceURL += baseServicePath(pathPrefix, "transfers", "API")
	urls := [1]string{
		serviceURL + "Search",
	}
...
func (c *aPIProtobufClient) Search(ctx context.Context, in *SearchI) (*SearchO, error) {
	ctx = ctxsetters.WithPackageName(ctx, "transfers")
...
const APIPathPrefix = "/twirp/transfers.API/"
...
func (s *aPIServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "transfers", "API")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2f, 0x48, 0x4a, 0xd3,
	0x2f, 0x29, 0x4a, 0xcc, 0x2b, 0x4e, 0x4b, 0x2d, 0x2a, 0xd6, 0x4f, 0x2c, 0xc8, 0xd4, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x84, 0x0b, 0x4a, 0x49, 0xa1, 0xaa, 0x29, 0x4e, 0x4d, 0x2c, 0x4a,
	0xce, 0x80, 0x28, 0x33, 0xb2, 0xe4, 0x62, 0x76, 0x0c, 0xf0, 0x14, 0x32, 0xe2, 0x62, 0x0b, 0x06,
	0x0b, 0x0b, 0x09, 0xe9, 0xc1, 0x55, 0xea, 0x41, 0x84, 0x3c, 0xa5, 0x30, 0xc5, 0xfc, 0x95, 0x18,
	0x9c, 0xf8, 0xa2, 0x78, 0xf4, 0xf4, 0xad, 0xe1, 0x32, 0x49, 0x6c, 0x60, 0x13, 0x8d, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0xd2, 0xea, 0xa4, 0x09, 0x93, 0x00, 0x00, 0x00,
}
